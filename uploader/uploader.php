<?php #CHI_ARTICLE UPLOADER v1.0

if (isset($_POST['submit'])) {
    $csv = array();
    $tmpName = $_FILES['csv']['tmp_name'];
    $array = array_map('str_getcsv', file($tmpName));
...
# CSV FORMAT : id,title,author,year,num of paragraphs,content(par 1),content(par 2)......
...
<head>
    <title>CHI_ARTICLE UPLOADER v1.0</title>
...
<body>
    <div class="main-block">
        <h1>CHI_ARTICLE UPLOADER v1.0</h1>

        <form action="uploader.php" method="post" enctype="multipart/form-data">

            <br>
            <input type="file" name="csv" id="csv" class="input" required />
